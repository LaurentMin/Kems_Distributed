...
go build -o terminal-input terminal-input.go utils.go logs.go app-utils.go client-utils.go
echo "Built terminal-input"
go build -o terminal-display terminal-display.go app-utils.go utils.go logs.go client-utils.go
echo "Built display"
